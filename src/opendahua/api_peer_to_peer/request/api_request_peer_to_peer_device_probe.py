...
from opendahua.api_peer_to_peer.response.api_response_peer_to_peer_device_probe import ApiResponsePeerToPeerDeviceProbe
...
class ApiRequestPeerToPeerDeviceProbe(ApiRequestPeerToPeer[ApiResponsePeerToPeerDeviceProbe]):
    # Request constants.
    REQUEST_ENDPOINT = "/probe/device/{serial_number}"
    ...
    def get_response_class(self) -> Type[T]:
        return ApiResponsePeerToPeerDeviceProbe
